...
function loadClass(root) {
	AuthReqBody = root.lookup("com.talent.aio.examples.im.common.packets.AuthReqBody");
	AuthRespBody = root.lookup("com.talent.aio.examples.im.common.packets.AuthRespBody");
	
	JoinReqBody = root.lookup("com.talent.aio.examples.im.common.packets.JoinReqBody");
	JoinGroupResult = root.lookup("com.talent.aio.examples.im.common.packets.JoinGroupResult");
	JoinRespBody = root.lookup("com.talent.aio.examples.im.common.packets.JoinRespBody");
	
	ChatReqBody = root.lookup("com.talent.aio.examples.im.common.packets.ChatReqBody");
	ChatRespBody = root.lookup("com.talent.aio.examples.im.common.packets.ChatRespBody");
	
	ChatType = root.lookup("com.talent.aio.examples.im.common.packets.ChatType");
	DeviceType = root.lookup("com.talent.aio.examples.im.common.packets.DeviceType");
	Command = root.lookup("com.talent.aio.examples.im.common.packets.Command");
